...
if( fsockopen( 'www.google.com.br' , 80 , $errno , $errstr , 30 ) ){
	$site_https = "http://localhost/destersinfinity/"; // http://www.destersinfinity.com.br/
//	echo "Está on-line";
} else {
	$site_https = " ";
}
...
<head>
    ...
    <meta name="description" content="Dester's Infinity é uma empresa de serviços de manutenção de piscinas e jardins, deixando a sua piscina limpa e o seu jardim florido com uma bela paisagem.">
    <meta name="author" content="Michel Pereira">
    <meta name="keywords" content="dester desters dester's infinity serviços manutenção piscinas jardins jardinagem paisagismo jardim peças venda fornecimento">
    <meta name="robots" content="dester, desters, dester's, infinity, serviços, manutenção, piscinas, jardins, jardinagem, paisagismo, jardim, peças, venda, fornecimento">
    <meta name="googlebot" content="dester, desters, dester's, infinity, serviços, manutenção, piscinas, jardins, jardinagem, paisagismo, jardim, peças, venda, fornecimento">
<?php    echo "<link rel='shortcut icon' href='".$site_https."img/iconePortoBellas.ico'>"; ?>

	<meta http-equiv="refresh" content="5;url=#">

    <title>Dester's Infinity Serviços</title>
        ...
        <div class="container">
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand" href="index.html">
                    <img src="<?php echo $site_https; ?>img/logo_di_w.png" title="Dester's Infinity" width="200" height="150" />
                </a>
            </div>
